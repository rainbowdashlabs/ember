...
class EventFieldConfigTest {
    ...
    void roundTripGroupConfig() {
        var cfg = new EventFieldConfig(null, 7, null, null, true, null, false);
    ...
    void roundTripUserTypeConfig() {
        var cfg = new EventFieldConfig(null, null, StationUserType.TEAM, null, true, null, false);
        var parsed = EventFieldConfig.parse(cfg.toJson());
    ...
    void roundTripTagConfig() {
        var cfg = new EventFieldConfig(null, null, null, 12, false, null, false);
        var parsed = EventFieldConfig.parse(cfg.toJson());
    ...
    void roundTripEnumOptions() {
        var cfg = new EventFieldConfig(List.of("a", "b"), null, null, null, false, null, false);
        var parsed = EventFieldConfig.parse(cfg.toJson());
