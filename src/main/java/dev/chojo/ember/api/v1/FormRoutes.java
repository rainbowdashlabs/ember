...
public class FormRoutes implements Routes {
    ...
    public void register(JavalinDefaultRoutingApi routes, String prefix) {
        ...
        routes.post(prefix + "/forms/{id}/respond/{memberId}", this::submitForMember, Roles.MEMBER_MANAGER);
        routes.put(prefix + "/forms/{id}/respond/{memberId}", this::updateForMember, Roles.MEMBER_MANAGER);
