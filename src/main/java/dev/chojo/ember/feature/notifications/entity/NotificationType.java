...
public enum NotificationType {
    ...
    MOVEMENT_ADVANCED(NotificationParams.MovementMoved.class, "notification.movementAdvanced"),
    MOVEMENT_RAISED(NotificationParams.MovementRaised.class, "notification.movementRaised"),
