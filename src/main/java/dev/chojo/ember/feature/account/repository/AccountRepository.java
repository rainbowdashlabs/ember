...
public class AccountRepository {
    ...
    public InsertionResult createSession(
        ...
        return query(
                        "INSERT INTO account_session(account_id, token, expires_at, user_agent, location) VALUES(:account_id, :token, :expires_at, :user_agent, :location);")
                .single(Call.of()
                        .bind("account_id", accountId)
                        .bind("token", token)
                        .bind("expires_at", expiresAt, INSTANT_TIMESTAMP)
    ...
    public InsertionResult recordConsent(
            ...
            String userAgent) {
        return query(
                        "INSERT INTO gdpr_consent(account_id, consent_version, privacy_version, tos_version, ip_address, country, user_agent) VALUES(:account_id, :consent_version, :privacy_version, :tos_version, :ip_address, :country, :user_agent);")
                .single(Call.of()
                        .bind("account_id", accountId)
