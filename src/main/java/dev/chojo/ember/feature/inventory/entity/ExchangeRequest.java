 ...
 * @param namesArrivingItem whether the step this exchange stands on is the one that says which piece arrived, so
 *                          that asking for any later status without naming it moves nothing
