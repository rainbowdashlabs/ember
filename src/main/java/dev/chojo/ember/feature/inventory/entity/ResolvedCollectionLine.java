 ...
 *
 * <p>The two line kinds fall short differently and the numbers say which: a counted line that finds
 * three of four is a fraction, a named line that finds nothing is simply gone, because there is no
 * other piece that would do instead.
 *
 ...
 * @param label        the piece's name, or the inventory's on a counted line
