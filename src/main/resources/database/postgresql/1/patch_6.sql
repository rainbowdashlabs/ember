...
INSERT INTO ember_schema.station_permission (name) VALUES
    ('LOGIN'), ('USER'),
    ('ATTENDANCE_READ'), ('ATTENDANCE_EDIT'), ('ATTENDANCE_CONFIGURE'), ('ATTENDANCE_EXPORT'), ('ATTENDANCE_MANAGER'),
    ('INVENTORY_CREATE_EXTERNAL'), ('INVENTORY_CREATE_INTERNAL'), ('INVENTORY_CREATE'),
    ('INVENTORY_READ'), ('INVENTORY_EDIT'), ('INVENTORY_PROCUREMENT'), ('INVENTORY_CHECK'),
    ('INVENTORY_EXCHANGE'),
    ('INVENTORY_LENDING_REQUEST'), ('INVENTORY_LENDING_MANAGER'), ('INVENTORY_MANAGER'),
    ('EVENT_MANAGE_TEMPLATE'), ('EVENT_MANAGE_CATEGORY'), ('EVENT_EDIT'), ('EVENT_REGISTRATION'),
...
-- ============================================================
-- Fix quiz_test_answer: add unique constraint on (attempt_id, question_id)
-- to prevent duplicate answer rows from auto-save.
-- ============================================================

-- Remove duplicate answer rows, keeping only the latest (highest id) per attempt+question
DELETE FROM ember_schema.quiz_test_answer a
    USING ember_schema.quiz_test_answer b
