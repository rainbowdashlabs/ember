...
-- Change quiz question points from INT to NUMERIC to support fractional points (e.g. 0.5 per correct)
ALTER TABLE ember_schema.quiz_question ALTER COLUMN points TYPE NUMERIC USING points::numeric;
