...
#align(center)[
  #text(size: 14pt, weight: "bold")[#data.title]
]

#if data.subtitle != "" [
  #v(0.3em)
  #align(center)[
    #text(size: 9pt, fill: luma(100))[#data.subtitle]
  ]
]
...
#if data.rows.len() == 0 [
  #align(center)[#text(size: 10pt, fill: luma(100))[Niemand steht auf dieser Liste.]]
] else [
  #let col-widths = ()
