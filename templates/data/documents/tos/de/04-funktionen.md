## § 12 Öffentlich zugängliche Bereiche
...
(4) Der Betreiber darf öffentliche Bereiche technisch begrenzen, etwa durch Beschränkung der Zahl der Einreichungen je Zeitraum, und missbräuchlich genutzte Formulare abschalten.
...
(3) Zur Anzeige von Herkunftsangaben werden Anzeigenamen beteiligter Personen zwischengespeichert. Darüber hinausgehende personenbezogene Mitgliederdaten werden nicht übertragen.

(4) Ausleihanfragen zwischen Partnerwachen umfassen einen Nachrichtenaustausch. Für dessen Inhalte gelten §§ 9 und 10 entsprechend.

(5) Der Austausch setzt voraus, dass beide Instanzen eine zueinander passende Version verwenden. Er kann jederzeit durch eine der beteiligten Seiten beendet werden.

## § 14 KI-gestützte Funktionen

(1) Für die Erstellung von Fragen und Antworten in Wissenstests kann eine Wache einen externen Anbieter künstlicher Intelligenz einbinden. Der Zugang erfolgt über einen Zugangsschlüssel, den die Wache selbst beim Anbieter erwirbt und in der Plattform hinterlegt.

(2) Bei Nutzung dieser Funktion werden die eingegebenen Anweisungen sowie die übergebenen Inhalte an den gewählten Anbieter übermittelt und dort nach dessen Bedingungen verarbeitet. Die Wache prüft vor der Nutzung, ob eine Übermittlung zulässig ist, und übermittelt insbesondere keine personenbezogenen Daten von Mitgliedern.

(3) Die Wache ist gegenüber dem Anbieter selbst Vertragspartner. Kosten, Nutzungsbedingungen und Datenschutzbestimmungen des Anbieters gelten unmittelbar zwischen Wache und Anbieter. Der Betreiber ist daran nicht beteiligt.

(4) Erzeugte Inhalte können fehlerhaft, unvollständig oder irreführend sein. Sie sind vor der Verwendung zu prüfen. Eine Gewähr für Richtigkeit, Verwendbarkeit oder Rechtsfreiheit erzeugter Inhalte übernimmt der Betreiber nicht.

## § 15 Feeds, Exporte und Schnittstellen

(1) Kalender-, RSS- und Atom-Feeds werden über einen persönlichen Token bereitgestellt und geben Inhalte im Umfang der Berechtigung des Nutzers wieder. § 7 Absatz 4 gilt.

(2) Die Plattform stellt Exporte in menschenlesbaren und maschinenlesbaren Formaten bereit, unter anderem zur Wahrnehmung der Rechte auf Auskunft und Datenübertragbarkeit. Einzelheiten regelt die Datenschutzerklärung.

(3) Der Betreiber darf den Abruf begrenzen, wenn er die Verfügbarkeit der Plattform beeinträchtigt.

## § 16 Benachrichtigungen und E-Mail
