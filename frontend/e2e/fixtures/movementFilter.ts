...
/**
 * Leaves one filter of the movement queue ticking exactly the named entries, and closes it again.
 *
 ...
 * story about a movement that has ended has to take that tick off before its row is anywhere on the
 ...
 */
export async function setMovementFilter(page: Page, testId: string, entries: string[]): Promise<void> {
