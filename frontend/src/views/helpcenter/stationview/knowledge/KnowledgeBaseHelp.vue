...
<template>
  <HelpArticle :title="t('helpCenter.kb.title')" :subtitle="t('helpCenter.kb.subtitle')">
    <HelpSection :title="t('helpCenter.kb.whatIs')">
      <p>{{ t('helpCenter.kb.whatIsText') }}</p>
    </HelpSection>
    ...
    <HelpTip>{{ t('helpCenter.kb.tip') }}</HelpTip>
  </HelpArticle>
</template>
