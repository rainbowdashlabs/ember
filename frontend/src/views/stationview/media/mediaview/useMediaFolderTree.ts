 ...
 */
export function useMediaFolderTree(folders: Ref<StationFileFolder[]>, activeFolder: Ref<number | null>) {
    ...
    const folderById = computed(() => {
        const m = new Map<number, StationFileFolder>()
