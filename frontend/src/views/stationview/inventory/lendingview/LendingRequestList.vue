...
function requestPage(entry: LendingRequestResponse) {
  if (!routes.lendingRequest) return null
...
<template>
  <div class="flex flex-col gap-2">
    <RowLink v-for="entry in entries" :key="entry.request.id" :to="requestPage(entry)">
