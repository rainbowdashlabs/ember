...
/** The partner's board as this station reads it. */
const boardPage = computed(() => `/station/federation/boards/${props.board.partnerStationUid}/${props.board.shortKey}`)
...
<template>
    <RowLink :to="boardPage">
        <NeutralContainer class="cursor-pointer hover:ring-2 hover:ring-primary transition-all h-full">
            <div class="flex items-start justify-between gap-2">
                ...
                <IconButton
                    ...
                    @click="emit('toggle-bookmark', board)"
                />
            </div>
