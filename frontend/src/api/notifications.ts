...
export type NotificationType = 'NEW_NEWS' | 'NEWS_COMMENT' | 'COMMENT_MENTION' | 'EVENT_REGISTRATION_STATUS'
    | 'EXCHANGE_STATUS_CHANGE' | 'EXCHANGE_NEW_REQUEST' | 'MOVEMENT_DECLINED' | 'NEW_EVENT' | 'NEW_EVENTS_BATCH'
    ...
    | 'CLUSTER_MODULE_DENIED' | 'CLUSTER_QUOTA_CHANGED' | 'CLUSTER_MEMBER_ROLE_CHANGED'
