...
export default {
    ...
    inventory: {
        ...
        collections: {
            hint: 'Eine Sammlung hält fest, was zusammengehört: die Spiele für den Jugendabend, das Funkset mit Ladestation und Antenne. Sie reserviert nichts, sie merkt sich nur die Liste.',
            ...
            kindHint: 'Ein benanntes Stück ist immer genau eines. Eine Anzahl holt beliebige Stücke aus dem gewählten Inventar.',
            item: 'Gegenstand',
