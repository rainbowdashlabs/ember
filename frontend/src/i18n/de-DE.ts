...
export default {
    ...
    checkNotes: {
        ...
        waitingOn: {
            ANNOUNCED: 'Wartet auf die Abgabe des alten Teils',
            RECEIVED: 'Altes Teil ist da, Ersatz wird besorgt',
            SHIPPED: 'Ersatz ist unterwegs',
            ARRIVED: 'Ersatz liegt bereit zur Übergabe',
        },
    ...
    exchanges: {
        ...
        sortBy: {
            member: 'Mitglied (A-Z)',
            inventory: 'Ausstattung (A-Z)',
            status: 'Status (Reihenfolge)',
        ...
        correct: 'Status richtigstellen',
        correctTitle: 'Status von Hand setzen',
        correctHint: 'Der Status ergibt sich sonst daraus, wo die beiden Teile gerade liegen. Von Hand gesetzt werden die Teile entsprechend gelegt. Der Vorgang steht mit Grund und Name im Verlauf, und niemand wird darüber benachrichtigt.',
        correctStatus: 'Richtiger Status',
        correctReason: 'Grund',
        correctReasonPlaceholder: 'Warum stimmt der bisherige Status nicht?',
        correctSubmit: 'Status setzen',
