...
export default {
    ...
    signupLists: {
        ...
        setSummary: 'Auf die Liste kommen {count} Personen, die am {date} einen Platz haben.',
        guestsLeftOut: 'Dazu kommen {count} Zusagen von Partnerwachen. Sie sind hier keine Mitglieder und können deshalb nicht auf die Liste.',
