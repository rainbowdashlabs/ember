...
library.add(
    ...
    faHouse, faChartLine, faShield, faSitemap, faBuilding, faGears, faUsers, faUserGroup, faUserPlus, faRightLeft, faList,
    ...
    faSortDown, faAsterisk, faEye, faLink, faTableColumns, faBan, faBarcode, faComment, faCheckDouble,
