...
- **Tables remember their columns.** The columns chosen for a table are still chosen on the next visit in the same browser, and the member list keeps its own choice for each tab.
